...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<md-toolbar>\n  <span>{{title}}</span>\n</md-toolbar>\n\n<md-grid-list cols=\"1\" rowHeight=\"16:9\">\n  <md-grid-tile>\n    <md-card>\n      <md-card-title>watering timer</md-card-title>\n      <md-card-content>Last access : <time>{{wateringTimer.lastAccess | amTimeAgo}}</time></md-card-content>\n      <md-card-actions>\n        <md-slide-toggle [(ngModel)]=\"wateringTimer.status\" (change)=\"onChange()\" >watering</md-slide-toggle>\n      </md-card-actions>\n    </md-card>\n  </md-grid-tile>\n</md-grid-list>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__devices_service__ = __webpack_require__("../../../../../src/app/devices.service.ts");
...
var AppComponent = (function () {
    function AppComponent(devicesService) {
        this.title = 'smart-garden';
        this.devicesService = devicesService;
    }
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.wateringTimer = { status: -1, lastAccess: new Date(0) };
        this.devicesService.getDevice(1190842).then(function (wateringTimer) {
            _this.wateringTimer = wateringTimer;
        });
    };
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__devices_service__["a" /* DevicesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__devices_service__["a" /* DevicesService */]) === "function" && _a || Object])
], AppComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__devices_service__ = __webpack_require__("../../../../../src/app/devices.service.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_8__devices_service__["a" /* DevicesService */]
        ],
